...
Route::middleware(['auth'])->group(function () {
    // Dashboard inteligente por rol/fase como principal
    ...
    // Cuentas de Cobro: Listado y registro general
    ...
    // Ciclo de aprobación por fase/rol
    ...
    // (Opcional para alcaldía, si usas métodos directos de aprobar/rechazar globales)
    Route::post('/cuenta-cobro/{cuenta}/aprobar', [CuentaCobroController::class, 'aprobar'])
        ->name('cuenta.cobro.aprobar')->middleware('role:alcalde');

    Route::post('/cuenta-cobro/{cuenta}/rechazar', [CuentaCobroController::class, 'rechazar'])
        ->name('cuenta.cobro.rechazar')->middleware('role:alcalde');
