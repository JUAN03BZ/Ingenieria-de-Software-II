                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><i class="fas fa-user text-primary me-2"></i><strong>{{ $user->name }}</strong></td>
                                            <td><i class="fas fa-envelope text-muted me-2"></i>{{ $user->email }}</td>
                                            <td><small class="text-muted"><i class="fas fa-calendar me-1"></i>{{ $user->created_at->format('d/m/Y') }}</small></td>
                                            @if(Auth::user()->hasAnyRole(['alcalde', 'contratacion']))
...
<script>
    ...
    function removeRole(userId, userName) {
        if (confirm(`¿Estás seguro de remover el rol de ${userName}?`)) {
            ...
            .catch(() => alert('Error al remover el rol'));
        }
    }
</script>
@endpush
