...
<div class="card shadow">
    ...
    <div class="card-body">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <strong class="text-capitalize" style="color: #141414;">
                                @switch($role->name)
                                    @case('contratista') <i class="fas fa-user-tie me-1 text-info"></i> @break
                                    @case('supervisor') <i class="fas fa-user-check me-1 text-success"></i> @break
                                    @case('alcalde') <i class="fas fa-crown me-1 text-warning"></i> @break
                                    @case('ordenador_gasto') <i class="fas fa-money-check-alt me-1 text-primary"></i> @break
                                    @case('tesoreria') <i class="fas fa-coins me-1 text-success"></i> @break
                                    @case('contratacion') <i class="fas fa-handshake me-1 text-info"></i> @break
        ...
        <div class="text-center py-5">
            ...
            <h4 class="text-light">No hay roles registrados</h4>
            <p class="text-muted mb-4">Comienza creando el primer rol del sistema.</p>
            @if($canManageRoles)
