...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/editar-rol.css') }}">
@endpush
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label fw-bold">
                                    <i class="fas fa-hashtag me-1"></i>ID del Rol
                                </label>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-control-plaintext bg-light">
                                    ...
                                    <small class="d-block">Rol del sistema (no modificable)</small>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-control-plaintext bg-light">
                                    {{ $role->description }}
                                    <small class="d-block">Descripción del sistema (no modificable)</small>
                                </div>
                            ...
                            <div class="mb-3">
                                <div class="card bg-light">
                                    <div class="card-body py-2">
                                        <h6 class="mb-1">
                                            <i class="fas fa-chart-pie me-1"></i>Estadísticas del Rol
                                        </h6>
